...
namespace Project_2_Dimension_Data_Collab.Data
{
    public partial class Dimension_Data_CollabContext : DbContext
    {
        public Dimension_Data_CollabContext()
        {
        }

        public Dimension_Data_CollabContext(DbContextOptions<Dimension_Data_CollabContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Initial Catalog=Dimension_Data_Collab;Data Source=Wallies-Dell;Trusted_Connection=true");
            }
        }
